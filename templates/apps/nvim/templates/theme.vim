...
let s:gui00        = "f{{theme.vim.bg0}}"
let g:base16_gui00 = "f{{theme.vim.bg0}}"
let s:gui01        = "f{{theme.vim.bg1}}"
let g:base16_gui01 = "f{{theme.vim.bg1}}"
let s:gui02        = "f{{theme.vim.bg2}}"
let g:base16_gui02 = "f{{theme.vim.bg2}}"
let s:gui03        = "f{{theme.vim.bg3}}"
let g:base16_gui03 = "f{{theme.vim.bg3}}"
let s:gui04        = "f{{theme.vim.fg3}}"
let g:base16_gui04 = "f{{theme.vim.fg3}}"
let s:gui05        = "f{{theme.vim.fg2}}"
let g:base16_gui05 = "f{{theme.vim.fg2}}"
let s:gui06        = "f{{theme.vim.fg1}}"
let g:base16_gui06 = "f{{theme.vim.fg1}}"
let s:gui07        = "f{{theme.vim.fg0}}"
let g:base16_gui07 = "f{{theme.vim.fg0}}"
let s:gui08        = "f{{theme.vim.red}}"
let g:base16_gui08 = "f{{theme.vim.red}}"
let s:gui09        = "f{{theme.vim.orange}}"
let g:base16_gui09 = "f{{theme.vim.orange}}"
let s:gui0A        = "f{{theme.vim.yellow}}"
let g:base16_gui0A = "f{{theme.vim.yellow}}"
let s:gui0B        = "f{{theme.vim.green}}"
let g:base16_gui0B = "f{{theme.vim.green}}"
let s:gui0C        = "f{{theme.vim.cyan}}"
let g:base16_gui0C = "f{{theme.vim.cyan}}"
let s:gui0D        = "f{{theme.vim.blue}}"
let g:base16_gui0D = "f{{theme.vim.blue}}"
let s:gui0E        = "f{{theme.vim.violet}}"
let g:base16_gui0E = "f{{theme.vim.violet}}"
let s:gui0F        = "f{{theme.vim.magenta}}"
