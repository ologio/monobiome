...
let s:gui00        = "f{{vim.bg0}}"
let g:base16_gui00 = "f{{vim.bg0}}"
let s:gui01        = "f{{vim.bg1}}"
let g:base16_gui01 = "f{{vim.bg1}}"
let s:gui02        = "f{{vim.bg2}}"
let g:base16_gui02 = "f{{vim.bg2}}"
let s:gui03        = "f{{vim.bg3}}"
let g:base16_gui03 = "f{{vim.bg3}}"
let s:gui04        = "f{{vim.fg3}}"
let g:base16_gui04 = "f{{vim.fg3}}"
let s:gui05        = "f{{vim.fg2}}"
let g:base16_gui05 = "f{{vim.fg2}}"
let s:gui06        = "f{{vim.fg1}}"
let g:base16_gui06 = "f{{vim.fg1}}"
let s:gui07        = "f{{vim.fg0}}"
let g:base16_gui07 = "f{{vim.fg0}}"
let s:gui08        = "f{{vim.red}}"
let g:base16_gui08 = "f{{vim.red}}"
let s:gui09        = "f{{vim.orange}}"
let g:base16_gui09 = "f{{vim.orange}}"
let s:gui0A        = "f{{vim.yellow}}"
let g:base16_gui0A = "f{{vim.yellow}}"
let s:gui0B        = "f{{vim.green}}"
let g:base16_gui0B = "f{{vim.green}}"
let s:gui0C        = "f{{vim.cyan}}"
let g:base16_gui0C = "f{{vim.cyan}}"
let s:gui0D        = "f{{vim.blue}}"
let g:base16_gui0D = "f{{vim.blue}}"
let s:gui0E        = "f{{vim.violet}}"
let g:base16_gui0E = "f{{vim.violet}}"
let s:gui0F        = "f{{vim.magenta}}"
let g:base16_gui0F = "f{{vim.magenta}}"

let s:grey         = "f{{vim.grey}}"
...
if has("nvim")
  let g:terminal_color_0 =  "f{{vim.bg0}}"
  let g:terminal_color_1 =  "f{{vim.red}}"
  let g:terminal_color_2 =  "f{{vim.green}}"
  let g:terminal_color_3 =  "f{{vim.yellow}}"
  let g:terminal_color_4 =  "f{{vim.blue}}"
  let g:terminal_color_5 =  "f{{vim.violet}}"
  let g:terminal_color_6 =  "f{{vim.cyan}}"
  let g:terminal_color_7 =  "f{{vim.fg2}}"
  let g:terminal_color_8 =  "f{{vim.bg3}}"
  let g:terminal_color_9 =  "f{{vim.red}}"
  let g:terminal_color_10 = "f{{vim.green}}"
  let g:terminal_color_11 = "f{{vim.yellow}}"
  let g:terminal_color_12 = "f{{vim.blue}}"
  let g:terminal_color_13 = "f{{vim.violet}}"
  let g:terminal_color_14 = "f{{vim.cyan}}"
  let g:terminal_color_15 = "f{{vim.fg0}}"
